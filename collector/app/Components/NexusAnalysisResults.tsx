    ...
    return (
      <div className="space-y-8">
        <FinalViabilityFour
          ...
          esg={null}
          esgNote="Not shown for address-only runs. Select a catalog building for demo ESG."
        />
        <WaterEconomicsThree
  ...
  return (
    <div className="space-y-8">
      ...
      {building.cv_reasoning ? (
        <p className="text-sm leading-relaxed text-slate-600">{building.cv_reasoning}</p>
      ) : null}
    </div>
  );
}
